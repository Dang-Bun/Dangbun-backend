...
class NotificationJpaEntityReceiverServiceTest {
    ...
    void getReceivedNotifications_success() {
        // given
        NotificationJpaEntity notificationJpaEntity = NotificationJpaEntity.builder()
                .content("알림 내용")
                .sender(mockMember)
                .build();
        ReflectionTestUtils.setField(notificationJpaEntity, "notificationId", 10L);
        ReflectionTestUtils.setField(notificationJpaEntity, "createdAt", LocalDateTime.now());

        NotificationReceiverJpaEntity receiver = NotificationReceiverJpaEntity.builder()
        ...
        Page<NotificationReceiverJpaEntity> mockPage = new PageImpl<>(List.of(receiver), pageable, 1);
    ...
    void markAsRead_success() {
        ...
        NotificationReceiverJpaEntity receiver = spy(NotificationReceiverJpaEntity.builder()
                .notificationJpaEntity(notificationJpaEntity)
                .receiver(mockMember)
                .isRead(false)
                .build());

        given(notificationReceiverRepository.findByNotificationJpaEntity_NotificationIdAndReceiver_MemberId(
