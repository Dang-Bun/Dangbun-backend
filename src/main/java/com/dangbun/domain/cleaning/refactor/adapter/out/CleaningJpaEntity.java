package com.dangbun.domain.cleaning.refactor.adapter.out;
...
public class CleaningJpaEntity extends BaseEntity {
    ...
    @Builder
    public CleaningJpaEntity(String name, CleaningRepeatType repeatType, String repeatDays, DutyJpaEntity duty, Boolean needPhoto, Place place) {
        this.name = name;
