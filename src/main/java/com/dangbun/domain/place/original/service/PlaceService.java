//package com.dangbun.domain.place.original.service;
//
...
//            Duty duty = dc.getKey();
//            List<GetPlaceResponse.CheckListDto> checkListDtos = new ArrayList<>();
//
...
//
//                if (containsMe) {
//                    checkListDtos.add(GetPlaceResponse.CheckListDto.of(checkList, members));
//                }
//            }
//
