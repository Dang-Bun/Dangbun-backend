package com.dangbun.domain.member.refactor.adapter.in.web.dto.request;

import com.dangbun.domain.member.refactor.application.port.in.command.RemoveMemberCommand;
