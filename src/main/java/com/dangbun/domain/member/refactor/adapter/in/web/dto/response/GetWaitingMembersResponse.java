...
import com.dangbun.domain.member.refactor.application.port.in.query.WaitingMembersResult;
...
public record GetWaitingMembersResponse(
    ...
    public static GetWaitingMembersResponse from(WaitingMembersResult result) {
