...
class MemberMapper {
    ...
    private com.dangbun.domain.member.original.entity.MemberRole toJpaRole(MemberRole role) {
        return com.dangbun.domain.member.original.entity.MemberRole.valueOf(role.name());
    }

    private MemberRole toDomainRole(com.dangbun.domain.member.original.entity.MemberRole role) {
