...
import static com.dangbun.domain.checklist.refactor.response.status.ChecklistExceptionResponse.ALREADY_CHECKED;
import static com.dangbun.domain.checklist.refactor.response.status.ChecklistExceptionResponse.ALREADY_UNCHECKED;
...
public class ChecklistJpaEntity extends BaseEntity {
    ...
    public void completeChecklist(MemberJpaEntity member){
